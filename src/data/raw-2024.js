...
export const RAW_2024={
  ...
  feats:[
    ...
    {id:"boon-fate",name:"Boon of Fate",category:"Epic Boon",abilityAdd:1,abilityMaximum:30},
    {id:"boon-irresistible-offense",name:"Boon of Irresistible Offense",category:"Epic Boon",abilityAdd:1,abilityMaximum:30,abilityChoices:["str","dex"]},
    {id:"boon-night-spirit",name:"Boon of the Night Spirit",category:"Epic Boon",abilityAdd:1,abilityMaximum:30},
  ...
  classes:[
    {id:"barbarian",name:"Barbarian",maxLevel:20,asiLevels:[4,8,12,16],epicBoon:{level:19,feat:"boon-irresistible-offense"},hitDie:12,saves:["str","con"],skillCount:2,skillChoices:["animalHandling","athletics","intimidation","nature","perception","survival"],primary:["str"],abilityPriority:["str","con","dex","wis","cha","int"],subclassLevel:3,equipmentPackages:[{id:"greataxe",armor:null,weapons:["greataxe","handaxe","handaxe","handaxe","handaxe"],shield:false,gear:["Explorer's Pack","15 GP"]}]},
    ...
    {id:"cleric",name:"Cleric",maxLevel:20,asiLevels:[4,8,12,16],epicBoon:{level:19,feat:"boon-fate"},hitDie:8,saves:["wis","cha"],skillCount:2,skillChoices:["history","insight","medicine","persuasion","religion"],primary:["wis"],abilityPriority:["wis","con","str","dex","cha","int"],subclassLevel:3,spellcasting:"cleric",equipmentPackages:[{id:"priest",armor:"chain-shirt",weapons:["mace"],shield:true,gear:["Holy Symbol","Priest's Pack","7 GP"]}]},
    {id:"rogue",name:"Rogue",maxLevel:20,asiLevels:[4,8,10,12,16],epicBoon:{level:19,feat:"boon-night-spirit"},hitDie:8,saves:["dex","int"],skillCount:4,skillChoices:["acrobatics","athletics","deception","insight","intimidation","investigation","perception","persuasion","sleightOfHand","stealth"],primary:["dex"],abilityPriority:["dex","con","wis","int","cha","str"],subclassLevel:3,extraLanguages:1,equipmentPackages:[{id:"burglar",armor:"leather",weapons:["dagger","dagger","shortsword","shortbow"],shield:false,gear:["20 Arrows","Quiver","Thieves' Tools","Burglar's Pack","8 GP"]}]}
  ],
  subclasses:[{id:"berserker",classId:"barbarian",name:"Path of the Berserker",level:3},{id:"champion",classId:"fighter",name:"Champion",level:3},{id:"evoker",classId:"wizard",name:"Evoker",level:3},{id:"life-domain",classId:"cleric",name:"Life Domain",level:3},{id:"thief",classId:"rogue",name:"Thief",level:3}],
  ...
  armor:{"chain-mail":{name:"Chain Mail",formula:"fixed",base:16},"studded-leather":{name:"Studded Leather Armor",formula:"light",base:12},"chain-shirt":{name:"Chain Shirt",formula:"medium",base:13},leather:{name:"Leather Armor",formula:"light",base:11}},
  weapons:{greataxe:{name:"Greataxe",damage:"1d12",ability:"str",type:"Slashing",mastery:"Cleave"},handaxe:{name:"Handaxe",damage:"1d6",ability:"str",type:"Slashing",mastery:"Vex"},greatsword:{name:"Greatsword",damage:"2d6",ability:"str",type:"Slashing",mastery:"Graze"},longsword:{name:"Longsword",damage:"1d8",ability:"str",type:"Slashing",mastery:"Sap"},flail:{name:"Flail",damage:"1d8",ability:"str",type:"Bludgeoning",mastery:"Sap"},javelin:{name:"Javelin",damage:"1d6",ability:"str",type:"Piercing",mastery:"Slow"},scimitar:{name:"Scimitar",damage:"1d6",ability:"dex",type:"Slashing",mastery:"Nick"},shortsword:{name:"Shortsword",damage:"1d6",ability:"dex",type:"Piercing",mastery:"Vex"},shortbow:{name:"Shortbow",damage:"1d6",ability:"dex",type:"Piercing",mastery:"Vex"},longbow:{name:"Longbow",damage:"1d8",ability:"dex",type:"Piercing",mastery:"Slow"},dagger:{name:"Dagger",damage:"1d4",ability:"dex",type:"Piercing",mastery:"Nick"},quarterstaff:{name:"Quarterstaff",damage:"1d6",ability:"str",type:"Bludgeoning",mastery:"Topple"},mace:{name:"Mace",damage:"1d6",ability:"str",type:"Bludgeoning",mastery:"Sap"}}
};
