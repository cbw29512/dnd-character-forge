...
export const REFERENCE_2014={
  ...
  feature:{
    "Spellcasting":r("Class","Magic","Use the spell section above for save DC, attack bonus, slots, and prepared spells. Expended spell slots return after a Long Rest."),
    ...
    "Turn Undead":r("Cleric","Action","Present your Holy Symbol. Undead within 30 ft that can see or hear you make a Wisdom save; failures are turned for up to 1 minute or until damaged and must flee when able."),
...
export const REFERENCE_2024={
  ...
  feature:{
    ...
    "Turn Undead":r("Cleric","Magic action","Undead you choose within 30 ft make a Wisdom save. A failure leaves them Frightened and Incapacitated for up to 1 minute, moving away when able; taking damage ends the effect."),
    "Life Domain":r("Life Domain","Passive","Life Domain features and always-prepared spells are reflected elsewhere on this sheet."),
