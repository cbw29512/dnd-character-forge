...
function featureReference(c,name){
  try{
    const p=c.ranger,s=c.rangerSelections||{},refs={
      ...
      "Hunter's Prey":rr("Hunter","Subclass choice",`Current Hunter's Prey option: ${prettyChoice(c,s.huntersPrey)}.`),
      ...
      "Defensive Tactics":rr("Hunter","Subclass choice",`Current Defensive Tactics option: ${prettyChoice(c,s.defensiveTactics)}.`),
