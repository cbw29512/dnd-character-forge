...
export function deriveCharacter(character,data){
  try{
    ...
    const speciesBonusHp=speciesHpBonus(character),draconicHpBonus=sorcererDraconicHpBonus(character),hp=averageHp(character.class.hitDie,character.level,con)+speciesBonusHp+draconicHpBonus,alert=character.feats.some(f=>f.id==="alert")?pb:0;
