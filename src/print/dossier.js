...
function seedFor(character){return hash([character.name,character.ruleset,character.level,character.class?.id,character.subclass?.id||character.subclass?.name,character.species?.id||character.species?.name,character.background?.id||character.background?.name].join("|"));}
