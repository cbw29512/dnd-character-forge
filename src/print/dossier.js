...
export function buildNarrativeDossier(character,{quickTurn=[]}={}){
  try{
    ...
    return Object.freeze({
      ...
      appearance:Object.freeze([`Adult ${species} with ${ABILITY_BEARING[ability]||ABILITY_BEARING.wis}.`,capitalize(classStory.look)+".",`Carries ${token} among otherwise practical travel gear.`,`Moves like someone accustomed to danger rather than someone trying to look dangerous.`,`First impression: controlled, observant, and more difficult to move from a decision than expected.`]),
