...
test("saved Bard spell state restores non-overlapping 2014 source buckets",()=>{
  ...
  assert.deepEqual(Object.keys(emptySpellSelections()).sort(),["cantrips","known","loreDiscoveries","magicalSecrets","masteryLevel1","masteryLevel2","prepared","signatureSpells","spellbook"].sort());
});
