...
console.log(`[class-identity-browser-print] verified ${CLASSES.length} deluxe class identities, illustrated portraits, and ink-saver emblems in Chrome`);
...
function verifyClass(classId){
  try{
    ...
    console.log(`[class-identity-browser-print] ${classId}: ${expected} pages · ${model.theme.id} · illustrated class portrait`);
