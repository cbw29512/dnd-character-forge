...
console.log(`[class-identity-browser-print] verified ${CLASSES.length} deluxe class identities, decoded visually complete portraits, and ink-saver emblems in Chrome`);
...
function verifyClass(classId){
  ...
  console.log(`[class-identity-browser-print] ${classId}: ${expected} pages · ${model.theme.id} · decoded visually complete class portrait`);
}
