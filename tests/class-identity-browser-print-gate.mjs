...
console.log(`[class-identity-browser-print] verified ${CLASSES.length} deluxe class identities and crisp class placeholders in Chrome`);
...
function verifyClass(classId){
  try{
    ...
    console.log(`[class-identity-browser-print] ${classId}: ${expected} pages · ${model.theme.id} · crisp class art`);
