...
async function verify(item,port){
  ...
  assert.equal(audit.validatedProof,true,`${item.name}: roster did not report four Rules Lawyer Certified members with the exact Forge build ID`);
