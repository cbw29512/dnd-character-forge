...
console.log(`[class-signature-ink-saver] verified ${CASES.length} grayscale-safe class identities in Chrome`);
...
function verifyInkSaver(classId){
  try{
    ...
    console.log(`[class-signature-ink-saver] ${classId}: ${expected} pages · ${model.theme.grayscalePattern}`);
