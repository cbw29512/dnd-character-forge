...
> Current status: **friend-test / release-candidate hardening** (`0.9.0-audit.1`). The exact production build is green across the release-critical automated gates and is ready for hands-on friend testing. It has not yet been promoted to the final 1.0 commercial release.
...
- Includes generated SRD spell-reference catalogs for the supported 2014 and 2024 spell surfaces.
...
- Generated PDF/print output is browser-certified for page count, layout, class identity, representative rules content, and Deluxe page-one footer separation.
...
- all 12 Deluxe class identities and page-one print geometry;
...
Character Forge does not require an account. Saved Pregens, Homebrew records, and saved presentation data are stored locally in the user's browser. Backup export/import is initiated by the user. The application does not include an analytics or telemetry client.

See [`PRIVACY.md`](PRIVACY.md) for the concise privacy disclosure.
...
- complete the final human acceptance pass using the deployed candidate;
...
Additional subclass/content expansion and non-defect polish are **not** required for the initial production release.
